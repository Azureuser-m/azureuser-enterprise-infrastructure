# STARTUP - Zabbix - Workstations.ps1
...
$ScriptLog    = Join-Path $LogRoot 'zabbix-workstation-startup.log'
$MsiLog       = Join-Path $LogRoot 'zabbix-workstation-msi.log'
...
try {
    Write-Log "=== Zabbix workstation startup script started ==="
    ...
    Write-Log "=== Zabbix workstation startup script completed successfully ==="
    exit 0
}
catch {
